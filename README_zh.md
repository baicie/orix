...
- **Workspace 支持** — monorepo 多包管理，支持 `workspace:*`、`workspace:^`、`workspace:~`、`workspace:>=`、`workspace:file:` 协议变体
- **跨平台** — Linux、macOS、Windows（junction 回退）
...
从 [GitHub Releases](https://github.com/baicie/orix/releases) 下载对应平台的压缩包，解压即可运行。
